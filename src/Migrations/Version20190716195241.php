 ...
 */
final class Version20190716195241 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pet (id INT AUTO_INCREMENT NOT NULL, sex_id INT NOT NULL, type_id INT NOT NULL, name VARCHAR(50) NOT NULL, birthdate DATE NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, INDEX IDX_E4529B855A2DB2A0 (sex_id), INDEX IDX_E4529B85C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
